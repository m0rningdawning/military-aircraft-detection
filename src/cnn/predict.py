...
model = load_model('../models/efficientnet_aircraft_classifier.h5')

classes = np.load('../data/ready/classes.npy', allow_pickle=True).item()
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Military Aircraft Classifier Prediction')
